...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadPokemons(page = 1) {
        ...
        if (typeFilter)
            params.append("type_", typeFilter);
        try {
    ...
    async function simulateBattle(battleState, modal) {
        const hpBar1 = document.getElementById("modal-hpbar1");
        const hpBar2 = document.getElementById("modal-hpbar2");
        const modalStatus = document.getElementById("modal-status");
